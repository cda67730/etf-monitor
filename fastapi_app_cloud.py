...
class DatabaseQuery:
    ...
    def get_warrant_available_dates(self):
        """獲取可用的權證數據日期"""
        if not self.db_available:
            return []
    ...
    def _get_placeholder(self):
        ...
        if not self.db_available:
            return "?"
        return "%s" if db_config.db_type == "postgresql" else "?"
    ...
    def get_etf_codes(self):
        return ['00980A', '00981A', '00982A', '00983A', '00984A', '00985A']
    ...
    def get_previous_holdings(self, etf_code, current_date):
        ...
        try:
            ...
            holdings_results = self.execute_query(
                get_holdings_query, 
...
# [這裡保持所有原有的路由：/, /holdings/{etf_code}, /changes, /new-holdings, 
#  /decreased-holdings, /cross-holdings, /holdings, /manual-scrape, /trigger-scrape, 
#  /test-scrape, /login, /logout, /health, /debug/session, /diagnostic 等]
